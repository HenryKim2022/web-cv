(function() {
  ...
  // ONLINE/OFFLINE CHECKER
      window.addEventListener("load", (event) => {
          let content = document.getElementById('online-status');
          content.textContent = "";
  
          let textContent = `${navigator.onLine ? "" : "You're Offline :("} `;
  ...
  $("#ig").click(function() {
    window.open(
      "https://instagram.com/henrykim119?igshid=ZDdkNTZiNTM=", '_blank' 
    );
  });

  $("#github").click(function() {
    window.open(
      "https://github.com/HenryKim2022/web-cv", '_blank' 
    );
  });
